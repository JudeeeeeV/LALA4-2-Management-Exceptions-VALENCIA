...
public class Main {
    ...
    public static void assignPM(List<Person> persons, String developer, String manager) {
        ...
        for (Person p : persons) {
            ...
            if (dev != null && manage != null) {
                break;
            }
        }

        if (dev == null || manage == null) {
            throw new NoSuchElementException((manage == null ? manager : dev) + " does not exist");
        }

           dev.setProjectManager(manage);
